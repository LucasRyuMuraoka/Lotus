            ...
            <div class="carrinho-lista" id="carrinho-lista">
                ...
                <div class="carrinho-item">
                    ...
                    <div class="item-controles">
                        ...
                        <button class="remover-btn" wire:click="removeItem({{ $item->product->id }})" data-index="0">Remover</button>
                    </div>
                </div>
                @endforeach
        ...
        <div class="carrinho-resumo">
            ...
            <div class="cupom-area">
                ...
                <div class="cupom-input">
                    <input type="text" id="cupom" placeholder="Digite seu cupom" aria-label="Cupom de desconto" />
                    <button id="aplicar-cupom">Aplicar</button>
                </div>
                <p id="cupom-mensagem"></p>
            </div>
            ...
            <div class="entrega-info">
                ...
                <div id="entrega-form">
                    <div class="form-group">
                        ...
                        <input type="text" id="cep" placeholder="00000000" maxlength="8" aria-label="CEP" wire:model="zip_code" />
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="complemento" placeholder="Apto, Bloco, etc. (opcional)" aria-label="Complemento" wire:model="complement" />
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="bairro">Bairro</label>
                            <input type="text" id="bairro" placeholder="Bairro" aria-label="Bairro" wire:model="district" />
                        </div>
                        <div class="form-group">
